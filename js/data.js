...
const CM_RESTAURANTS = [
  ...
  },
  {
      ...
      menuHighlights:["Peking Duck", "Dim Sum", "Kung Pao Chicken"],
      cmNote:"ร้าน EATELIER มีเมนูจีนที่หลากหลายและบรรยากาศที่เหมาะสำหรับการเฉลิมฉลอง.",
      totalReviews:1,
    },
  {
      id:"r037",
      ...
      menuHighlights:["ข้าวแกงกะหรี่", "ข้าวแกงเขียวหวาน", "ข้าวแกงพะแนง"],
      cmNote:"ร้านนี้มีเมนูข้าวแกงหลากหลายและรสชาติอร่อยที่ไม่ควรพลาด!",
      totalReviews:1,
    },
  {
      id:"r038",
      ...
      recentReviewers:["Peach Eat Laek"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["Thai", "casual", "family-friendly"],
      menuHighlights:["ต้มยำกุ้ง", "ผัดไทย", "แกงเขียวหวาน"],
      cmNote:"ร้านนี้มีบรรยากาศสบายๆ และเมนูอาหารไทยที่อร่อยมาก",
      totalReviews:1,
    },
  {
      id:"r039",
      ...
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["kebab", "Indian cuisine"],
      menuHighlights:["Seekh Kebab", "Biryani", "Naan"],
      cmNote:"ร้านนี้มีเคบับที่อร่อยและเป็นที่นิยมในย่าน Delhi",
      totalReviews:1,
    },
  {
      id:"r040",
      name:"John & Mary Food Store",
      cuisine:"American",
      type:"casual-dining",
      budget:1,
      budgetLabel:"฿",
      ...
      recentReviewers:["Mark Wiens"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["family-friendly", "local"],
      menuHighlights:["Burgers", "Fries", "Milkshakes"],
      cmNote:"ร้านนี้มีบรรยากาศที่เป็นกันเองและเมนูที่หลากหลายเหมาะสำหรับครอบครัว.",
      totalReviews:1,
    },
  {
      id:"r041",
      name:"Banks Meat Market",
      cuisine:"American",
      type:"steakhouse",
      budget:2,
      budgetLabel:"฿฿",
      ...
      recentReviewers:["Mark Wiens"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["steak", "meat", "local"],
      menuHighlights:["Grilled Ribeye", "BBQ Brisket", "Smoked Sausage"],
      cmNote:"ร้านนี้มีชื่อเสียงในเรื่องของเนื้อคุณภาพสูงและบรรยากาศที่อบอุ่น",
      totalReviews:1,
    },
  {
      id:"r042",
      name:"ฮาน่า ก๋วยเตี๋ยวเนื้อตุ๋น",
      cuisine:"Thai",
      type:"casual-dining",
      budget:1,
      budgetLabel:"฿",
      ...
      recentReviewers:["ชีวิตติดรีวิว"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["ก๋วยเตี๋ยว", "เนื้อ"],
      menuHighlights:["ก๋วยเตี๋ยวเนื้อตุ๋น", "น้ำซุปเข้มข้น", "เส้นเหนียวนุ่ม"],
      cmNote:"ร้านนี้มีชื่อเสียงในเรื่องก๋วยเตี๋ยวเนื้อตุ๋นที่อร่อยและน้ำซุปที่เข้มข้น.",
      totalReviews:1,
    },
  {
      id:"r043",
      name:"ก๋วยเตี๋ยวหลอดเจ๊ปากแดง",
      cuisine:"Thai",
      type:"casual-dining",
      budget:1,
      budgetLabel:"฿",
      ...
      trendBadge:"↑ Rising",
      reviewerTiers:{mega:0, macro:1, mid:0},
      recentReviewers:["EaterOat"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["ก๋วยเตี๋ยว", "อาหารไทย"],
      menuHighlights:["ก๋วยเตี๋ยวหลอด", "ก๋วยเตี๋ยวต้มยำ", "ขนมจีนน้ำยา"],
      cmNote:"ร้านนี้มีชื่อเสียงในเรื่องก๋วยเตี๋ยวหลอดที่อร่อยและบรรยากาศสบายๆ เหมาะสำหรับการนัดพบเพื่อน.",
      totalReviews:1,
    },
  {
      id:"r044",
      ...
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["fresh seafood", "beachfront"],
      menuHighlights:["ปูผัดผงกะหรี่", "กุ้งเผา", "ปลาทอดสมุนไพร"],
      cmNote:"ร้านนี้มีบรรยากาศดีและอาหารทะเลสดใหม่ที่ไม่ควรพลาด!",
      totalReviews:1,
    },
  {
      id:"r045",
      name:"PULSE Bang Khun Thian",
      cuisine:"Thai",
      type:"casual-dining",
      budget:1,
      budgetLabel:"฿",
      ...
      recentReviewers:["GoWentGo"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["Thai food", "Bang Khun Thian"],
      menuHighlights:["เมนู 1", "เมนู 2", "เมนู 3"],
      cmNote:"ร้านนี้มีบรรยากาศที่น่านั่งและเมนูอาหารไทยที่อร่อยมาก",
      totalReviews:1,
    },
  {
      id:"r046",
      ...
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["streetfood", "Bangna"],
      menuHighlights:["เมนู 1", "เมนู 2", "เมนู 3"],
      cmNote:"ร้านนี้มีเมนูสตรีทฟู้ดที่อร่อยและเป็นเอกลักษณ์ในย่านบางนา",
      totalReviews:1,
    },
  {
      id:"r047",
      ...
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["steak", "Japanese"],
      menuHighlights:["Wagyu Steak", "Sushi Platter", "Ramen"],
      cmNote:"ร้านนี้มีสเต็กวากิวที่อร่อยและบรรยากาศดีมาก",
      totalReviews:1,
    },
  {
      id:"r048",
      ...
      menuHighlights:["ต้มยำกุ้ง", "ผัดไทย", "แกงเขียวหวาน"],
      cmNote:"ร้านนี้มีบรรยากาศดีและเมนูอาหารไทยที่หลากหลาย.",
      totalReviews:1,
    },
  {
      id:"r049",
      ...
      recentReviewers:["EatGuide"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["Thai food", "local cuisine"],
      menuHighlights:["ต้มยำกุ้ง", "ผัดไทย", "แกงเขียวหวาน"],
      cmNote:"ร้านนี้มีเมนูไทยดั้งเดิมที่อร่อยและบรรยากาศดีเหมาะสำหรับการนั่งชิล.",
      totalReviews:1,
    },
  {
      id:"r050",
      ...
      recentReviewers:["EatGuide"],
      bookingLinks:{googlemaps:"#", wongnai:"#"},
      tags:["dim sum", "Thai cuisine"],
      menuHighlights:["ติ่มซำกุ้ง", "ติ่มซำหมูสับ", "ติ่มซำผัก"],
      cmNote:"ร้านนี้มีติ่มซำที่อร่อยและหลากหลายให้เลือกสรร",
      totalReviews:1,
    },
];
...
const CM_SIGNALS = {
  weeklyHighlight: {
    title: "🌟 ร้านอาหาร Rising Stars ประจำสัปดาห์! 🍽️",
    desc: "Le Du และร้านใหม่ๆ อย่าง Haoma กำลังมาแรงในวงการอาหารไทย ขณะที่แนวโน้ม Fine Dining ยังคงเติบโตอย่างต่อเนื่อง!",
    trend: "rising"
  },
  trendCategories: [
    { cat:"Thai Fine Dining", signal:"strong", change:"+40%", influencers:5 },
    ...
    { cat:"Thai Street Food", signal:"stable",      change:"+8%",  influencers:1 },
