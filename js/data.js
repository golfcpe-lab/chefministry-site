...
const CM_SIGNALS = {
  weeklyHighlight: {
    title: "ร้านอาหารใหม่ที่น่าสนใจสัปดาห์นี้! 🍽️",
    desc: "สัปดาห์นี้ร้านอาหารใหม่กำลังมาแรงอย่างเกาะหมากซีฟู้ดและCha Cha Beach Club ที่ได้รับการรีวิวดีจาก YouTube! นอกจากนี้ ข้าวแกงสวนลุมยังคงมีความเคลื่อนไหวที่น่าสนใจในวงการอาหารไทย",
    restaurant: "ข้าวแกงสวนลุม",
    trend: "rising"
  },
  trendCategories: [
